...
class BookDirectoryTestSuite {
    ...
    void testListBooksInHandsOf(){
        //Given
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser libraryUser0 = new LibraryUser("Adam", "Nowak", "99123199999");
        List<Book> bookList0 = new ArrayList<>();
        LibraryUser libraryUser1 = new LibraryUser("Jan", "Nowak", "98123199999");
        List<Book> bookList1 = generateListOfNBooks(1);
        LibraryUser libraryUser5 = new LibraryUser("Wojciech", "Kowalski", "97123199999");
